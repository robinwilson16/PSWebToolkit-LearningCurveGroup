...
<div class="container">
    <div class="panel panel-primarylcg">
            ...
            <h2>16-19 BURSARY AND FREE MEALS APPLICATION FORM</h2>
             <p>Please notes LCG can only backdate payments four weeks from when application is received.</p>
 ...
 <div class="panel panel-primarylcg">
     <div class="panel-headinglcg" >Household Income</div>
        ...
        <p><i>To be completed by the parent/guardian (or the learner if they live alone)</i></p>
          ...
          <div class="row">
            <div class="col-sm-12 columns form-group"> 
            <span class="textfieldlabelrequired">* Is the total gross annual income for your household below £28,000?</span>
        ...
        <p>Please state gross annual income below:</p>
         <div class="row">
            ...
            <cc1:StudentEnrolmentField StudentEnrolmentFieldType="StudentDetailUserDefined6" CustomFieldType="NumberWithDecimals" ID="StudentEnrolmentField3" runat="server" IsRequired="false" LabelWidth="400" CustomCaption="Adult 1"  />
            </div>
             <div class="col-sm-3 columns form-group"> 
            <cc1:StudentEnrolmentField StudentEnrolmentFieldType="StudentDetailUserDefined7" CustomFieldType="NumberWithDecimals" ID="StudentEnrolmentField4" runat="server" IsRequired="false" LabelWidth="400" CustomCaption="Adult 2" />
            </div>
         </div>
        <p><i>You will need to evidence this on the ‘Evidence of Eligibility - Upload’ page</i></p>
    </div>
    <div class="panel panel-primarylcg">
     <div class="panel-headinglcg" >Financial Support</div>
        <p><i>To be completed by the parent/guardian (or the learner if they live alone)</i></p>
          ...
          <div class="row">
                <div class="col-sm-3 columns form-group"> 
                    <cc1:StudentEnrolmentField StudentEnrolmentFieldType="StudentDetailUserDefined5" ID="StudentEnrolmentField5" runat="server" CustomFieldType="NumberWithDecimals"  IsRequired="false" LabelWidth="450" CustomCaption="Travel -  please state the weekly cost of travel to the centre for learning" />
             </div>
          </div>
        <p>Please use this box to detail what other financial support is required where applicable (e.g. equipment or other courserelated costs, etc)</p>
              <div class="row">
                <div class="col-sm-12 columns form-group"> 
     ...
     <div class="panel panel-primarylcg">
         <div class="panel-headinglcg" >Bank details</div>
            ...
            <div class="form-group">
                ...
                <cc1:StudentEnrolmentField StudentEnrolmentFieldType="StudentDetailUserDefined10" ID="SortCode" runat="server" IsRequired="true" LabelWidth="400" CustomCaption="Sort Code (Include dashes (XX-XX-XX))" CustomFieldType="Text" Pattern="^(\d){2}-(\d){2}-(\d){2}$" Title="Please enter a valid Sort Code - Include dashes (XX-XX-XX)" />
            </div>
            <div class="form-group">

                <cc1:StudentEnrolmentField StudentEnrolmentFieldType="StudentDetailUserDefined11" ID="AccNo" runat="server" IsRequired="true" LabelWidth="450" CustomCaption="Account Number (8 digits no spaces or add 0 in front of 7 digit accounts)" CustomFieldType="Text" Pattern="^(\d){8}$" Title="Please enter a valid account number(8 digits no spaces) For 7 Digit account numbers, add a 0 at the beginning" />
            </div>
            <div class="form-group">

                <cc1:StudentEnrolmentField StudentEnrolmentFieldType="StudentDetailUserDefined12" ID="HolderName" runat="server" IsRequired="true" LabelWidth="400" CustomCaption="Account Holder Name" CustomFieldType="Text" />
            </div>
            <div class="form-group">

                <cc1:StudentEnrolmentField StudentEnrolmentFieldType="StudentDetailUserDefined13" ID="StudentEnrolmentField16" runat="server" IsRequired="False" LabelWidth="400" CustomCaption="Roll number (if applicable)" CustomFieldType="Text" />
            </div>
        </div>
    ...
    <div class="application-form__form-wrapper">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
                <td>I am aged 16-18 (or 19-24 with an EHCP) and have a total household income of less than £25,000</td>
                <td>Please provide evidence of household income</td>

            </tr>
            <tr>
                <td>I am aged 19 or over and have a total household income of less than £25,000</td>
            ...
            <tr>
                ...
                <td>I am aged 19 or over and have a total household income of less than £25,000 AND I am paying for my course with an Advanced Learning Loan
                </td>
    ...
    <div class="application-form__form-wrapper">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td>Please provide an award letter which is less than 6 months old or a recent bank statement which names the benefit that is received
                </td>

            </tr>
            <tr>
                <td>Universal Credit</td>
                <td>Please provide an award letter which is less than 6 months old or a recent bank statement which names the benefit that is received</td>
            ...
            <tr>
                ...
                <td>Working Tax Credit / Child Tax Credit
                </td>
                <td>Please provide all pages of the latest Tax Credit Award 
                </td>
   ...
   <hr />
        ...
        <div class="form-group">
            <ul>
                ...
                <li>We will contact you within 10 working days to confirm whether you place on your chosen transport route has been successful</li>
            </ul>
            </div>
