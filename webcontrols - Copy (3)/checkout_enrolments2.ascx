...
<div class="container">
 ...
 <div class="row">
        <div class="col-sm-12 columns form-group"> 
            <p><strong>* Are you a UK national and have you been ordinarily resident in the UK, EEA, Switzerland, or Gibraltar for at least the previous three years on your first day in learning?</strong></p>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
                <td>
                    ...
                    <asp:CheckBox id="chkUkraineExt" runat="Server" Text="Ukraine Extension Scheme" CssClass="checkbox-inline" ></asp:CheckBox><br />
                ...
                <td style="vertical-align:middle" >
                    ...
                    <br /><br />EUSS code to be provided to evidence current status
                </td>
            </tr>
            <tr>
                <td>
    ...
    <div class="row">
      ...
      <div class="row">
       ...
       <div class="col-sm-6 columns form-group">       
        ...
        <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="e.g., full British passport or Residency permit with indefinite leave to remain.">
...
<div class="container">
      ...
      <div class="row">
          <div class="col-sm-6 columns form-group"> 
           <cc1:StudentEnrolmentField StudentEnrolmentFieldType="EthnicGroupID" ID="StudentEnrolmentField3" runat="server" IsRequired="true" CustomCaption="* What is your ethnic group" LabelWidth="300"/>
          </div>
