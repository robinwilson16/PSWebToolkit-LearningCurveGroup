...
<div class="progress" style="height: 20px;">
  <div class="progress-barlcg" role="progressbar" style="width: 43%;" aria-valuenow="43" aria-valuemin="0" aria-valuemax="100"></div>
</div>
                <ol class="breadcrumb">
         ...
         if ($("#<%=selectEmployed.ClientID%>").val() == "10") {
             ...
             $('#<%= selectEmployed.ClientID %>').change(function () {
                ...
                //   $("#divEmployerDet1").hide();
                 ...
                 $('#ctl00_MainContentPlaceholder_ctl00_txtGrossSalary_txtStudentDetailUserDefined1').val(null)
    ...
    <div class="container">
      ...
      <div class="col-sm-6 columns form-group">            
                 <cc1:StudentEnrolmentField StudentEnrolmentFieldType="NI" ID="nino" runat="server"  IsRequired="false" CustomCaption="NI Number"  Pattern="^(?!BG)(?!GB)(?!NK)(?!KN)(?!TN)(?!NT)(?!ZZ)(?:[A-CEGHJ-PR-TW-Z][A-CEGHJ-NPR-TW-Z])(?:\s*\d\s*){6}([A-D]|\s)$"/>
  ...
  <%--        <h4>Employment</h4>   
    ...
    <div class=" form-group">
        ...
        <div class="col-sm-12 columns form-group"> 
             ...
             <asp:DropDownList ID="selectEmployed" runat="server"   CssClass="textfield form-control" EnableViewState="true">
   ...
   <div class="row"  id="divUnEmploymentLength" style="display:none">
        ...
        <div class="row">
       <div class="col-sm-12 columns form-group"> 
            <span class="textfieldlabelrequired">* My take-home pay is less than 16 times the appropriate age-related rate of national minimum wage/national living wage a week, or £345 per month (individual claim) or £552 a month (household claim)</span>
       ...
       <div class="col-sm-12 columns form-group"> 
         ...
         <div class="row">
        <div class="col-sm-12 columns form-group"> 
            <cc1:StudentEnrolmentField StudentEnrolmentFieldType="StudentDetailUserDefined1" ID="txtGrossSalary" runat="server" Visible="true" LabelWidth="265" Width="400" IsRequired="false"  CustomCaption="<strong>My Annual Gross Salary is</strong>"/>
          </div>
        </div>
    </div>
        
        <div class="panel panel-primarylcg" id="divBeneifts"  style="display:none">
         <h2>Benefit upload</h2>
