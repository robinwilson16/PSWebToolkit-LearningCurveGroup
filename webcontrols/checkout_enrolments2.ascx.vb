...
Partial Class webcontrols_checkout_enrolments2
    ...
    Protected Overrides Sub OnLoad(e As EventArgs)
        ...
        If Not IsPostBack Then
            ...
            selectUK12months.SelectedValue = WorkingData.EnrolmentRequestRow.StudentDetailUserDefined9
            EUSSCode.Value = WorkingData.EnrolmentRequestRow.StudentDetailUserDefined16
            ...
            If WorkingData.EnrolmentRequestRow.StudentDetailUserDefined23 = "True" Then chkdomesticabuse.Checked = WorkingData.EnrolmentRequestRow.StudentDetailUserDefined23
            If WorkingData.EnrolmentRequestRow.StudentDetailUserDefined34 = "True" Then chkbereavedpartner.Checked = WorkingData.EnrolmentRequestRow.StudentDetailUserDefined34
            If WorkingData.EnrolmentRequestRow.StudentDetailUserDefined12 = "True" Then chkAfghanPitting.Checked = WorkingData.EnrolmentRequestRow.StudentDetailUserDefined46
            If WorkingData.EnrolmentRequestRow.StudentDetailUserDefined13 = "True" Then chkAfghanEvac.Checked = WorkingData.EnrolmentRequestRow.StudentDetailUserDefined47
            If WorkingData.EnrolmentRequestRow.StudentDetailUserDefined18 = "True" Then chkAfghanResettle.Checked = WorkingData.EnrolmentRequestRow.StudentDetailUserDefined18
            If WorkingData.EnrolmentRequestRow.StudentDetailUserDefined19 = "True" Then chkAfghanEnterRemain.Checked = WorkingData.EnrolmentRequestRow.StudentDetailUserDefined19

            If WorkingData.EnrolmentRequestRow.EnrolmentUserDefined22 = "True" Then chkBIOT.Checked = WorkingData.EnrolmentRequestRow.EnrolmentUserDefined20
            If WorkingData.EnrolmentRequestRow.StudentDetailUserDefined14 = "True" Then chkUkraine.Checked = WorkingData.EnrolmentRequestRow.StudentDetailUserDefined48
                If WorkingData.EnrolmentRequestRow.StudentDetailUserDefined15 = "True" Then chkUkraineSpon.Checked = WorkingData.EnrolmentRequestRow.StudentDetailUserDefined49
    ...
    Private Sub btnContinue_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnContinue.Click
        ...
        WorkingData.EnrolmentRequestRow.StudentDetailUserDefined9 = selectUK12months.SelectedValue
        ...
        WorkingData.EnrolmentRequestRow.StudentDetailUserDefined23 = chkdomesticabuse.Checked
        WorkingData.EnrolmentRequestRow.StudentDetailUserDefined34 = chkbereavedpartner.Checked
        WorkingData.EnrolmentRequestRow.StudentDetailUserDefined12 = chkAfghanPitting.Checked
        WorkingData.EnrolmentRequestRow.StudentDetailUserDefined13 = chkAfghanEvac.Checked
        WorkingData.EnrolmentRequestRow.StudentDetailUserDefined18 = chkAfghanResettle.Checked
        WorkingData.EnrolmentRequestRow.StudentDetailUserDefined19 = chkAfghanEnterRemain.Checked
        WorkingData.EnrolmentRequestRow.EnrolmentUserDefined22 = chkBIOT.Checked
        WorkingData.EnrolmentRequestRow.StudentDetailUserDefined14 = chkUkraine.Checked
        WorkingData.EnrolmentRequestRow.StudentDetailUserDefined15 = chkUkraineSpon.Checked
    ...
    Public Overrides Sub ValidateControl()
        ...
        If selectEuro.SelectedValue = "2" And selectPreSettle.SelectedValue = "2" And selectEducation.SelectedValue = "" Then
            Dim v As New CustomValidator
        ...
        If selectEuro.SelectedValue = "2" And selectPreSettle.SelectedValue = "1" And EUSSCode.Value = "" Then
            Dim v As New CustomValidator
            v.ErrorMessage = "Please provide your Immigration Share Code"
            ' presettle.CssClass = "error"
            v.IsValid = False
            Me.Page.Validators.Add(v)
        End If

        If selectEuro.SelectedValue = "2" And selectPreSettle.SelectedValue = "" Then
            Dim v As New CustomValidator
        ...
        If selectUK12months.SelectedValue = "" Then
            Dim v As New CustomValidator
            v.ErrorMessage = " Do you currently have permission to stay in the UK for at least 12 months?"
            'rdoEuro.CssClass = "error"
            v.IsValid = False
            Me.Page.Validators.Add(v)
        End If
        ...
        If selectEducation.SelectedValue = "2" And selectPreSettle.SelectedValue = "2" And selectEuro.SelectedValue = "2" Then
            ...
            If chkDiscretionaryRemain.Checked = False And
                ...
                chkdomesticabuse.Checked = False And
                chkbereavedpartner.Checked = False And
                chkAfghanPitting.Checked = False And
                chkAfghanEvac.Checked = False And
                chkAfghanResettle.Checked = False And
                chkAfghanEnterRemain.Checked = False And
                chkUkraine.Checked = False And
                chkUkraineSpon.Checked = False And
                chkUkraineExt.Checked = False And
                chkBIOT.Checked = False And
