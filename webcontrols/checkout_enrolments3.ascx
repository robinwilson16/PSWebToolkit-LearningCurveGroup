...
<div class="progress" style="height: 20px;">
  <div class="progress-barlcg" role="progressbar" style="width: 75%;" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
</div>
  <ol class="breadcrumb">
...
<div class="container">
  <div class="row">
    ...
    <div class="row">
         ...
         <div class="col-sm-3 columns form-group">            
     		<cc1:StudentEnrolmentField StudentEnrolmentFieldType="ExpectedEndDate" ID="enddate" runat="server" IsRequired="false"  LabelWidth="350" CustomCaption="Expected End Date (roll on roll off course)"/>
          </div>
    </div>
</div>

        <cc1:CCCButton id="btnBack" runat="server" Text="Back" ImageResource="btnBack" LinkResource="checkout_quals_on_entry_aspx"/>
        <cc1:CCCButton ID="btnContinue" runat="server" Text="Continue" ImageResource="btnContinue" LinkResource="checkout_enrolments4_aspx" CausesValidation="true" />
    <br />
