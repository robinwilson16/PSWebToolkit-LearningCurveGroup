...
<div class="row usercontrol">
    ...
    <div class="col-lg-5 searchpanel text-center">
        <a href="http://www.acollege.ac.uk" title="Go to Compass website">
            <img class="img-responsive" src="_images/advanced-logo-header.png" alt="College Logo" /></a>
        <p>
        ...
        <div class="row">
            <div id="SearchAreaForKeyWords" runat="server">
                ...
                <div class="col-md-8 text-left">
                    <asp:TextBox Style="width: 100%; margin: 2px;" CssClass="searchBox textfield form-control" ID="txtKeywords" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div id="SearchAreaForCollegeLevel" runat="server">
                ...
                <div class="col-md-8 text-left">
                    <asp:DropDownList Style="width: 100%; margin: 2px;" CssClass="searchBox textfield form-control" ID="cboCollegeLevel" runat="server"></asp:DropDownList>
                </div>
            </div>
            <div id="SearchAreaForSite" runat="server">
                <div class="col-md-4 text-left">Location</div>
                <div class="col-md-8 text-left">
                    <asp:DropDownList Style="width: 100%; margin: 2px;" CssClass="searchBox textfield form-control" ID="cboSite" runat="server"></asp:DropDownList>
                </div>
            </div>
            <div id="SearchAreaForModeOfAttendance" runat="server">
                <div class="col-md-4 text-left">Attendance Mode</div>
                <div class="col-md-8 text-left">
                    <asp:DropDownList Style="margin: 2px;" CssClass="searchBox textfield form-control" ID="cboModeOfAttendance" runat="server"></asp:DropDownList>
                </div>
            </div>            
