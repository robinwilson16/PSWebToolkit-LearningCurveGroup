...
<script RunAt="server">
    ...
    Sub Application_Start(ByVal sender As Object, ByVal e As EventArgs)
        ...
        ' Fixes this error when setting the toolkit to use .NET 4.8; 
    ...
    Private Sub Initialise()
        ...
        CCCDatabaseConnectInfoList.LogicalAndMicroServiceNameMapping.Item("Enrolment") =
        "PSWebEnrolment"
        CCCDatabaseConnectInfoList.LogicalAndMicroServiceNameMapping.Item("ExamA2C") =
        "PSWebEnrolment"
        ...
        SystemSettings.AFDEvolution_Password = "ELL6URsm"
        SystemSettings.AFDEvolution_SerialNumber = "831768"
