  ...
  <div class="row">
    ...
    <div class="row">
         ...
         <div class="col-sm-3 columns form-group">            
                <cc1:StudentEnrolmentField StudentEnrolmentFieldType="StartDate" ID="startdate" runat="server" IsRequired="false"  CustomCaption="Start Date (roll on roll off course)"/>
          </div>
    </div>
</div>
