...
Partial Class webcontrols_checkout_enrolments
    ...
    Public Overrides Sub ValidateControl()
        ...
        If IsDate(WorkingData.EnrolmentRequestRow.DateOfBirth) Then
            ...
            '   End If
            WorkingData.EnrolmentRequestRow.StudentDetailUserDefined1 = Math.Floor(DateDiff(DateInterval.Day, CType(WorkingData.EnrolmentRequestRow.DateOfBirth, Date), CType("31-Aug-2022", Date)) / 365.25)
            If WorkingData.EnrolmentRequestRow.StudentDetailUserDefined1 < 16 Then
                Dim v As New CustomValidator
                v.ErrorMessage = "Learning Curve Group are unable to enrol students under the age of 16 (age is calculated at 31st August 2022)."
                v.IsValid = False
                Me.Page.Validators.Add(v)
