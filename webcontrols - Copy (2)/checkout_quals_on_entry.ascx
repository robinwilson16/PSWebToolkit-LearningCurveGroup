...
<div class="container">
  <div class="row">
   ...
   <div class="row">
      <div class="col-sm-6 columns form-group"> 
                     <cc1:StudentEnrolmentField id="StudentEnrolmentField4" runat="server" customcaption="Do you have Functional Skills vL2 in English?" isrequired="False" labelwidth="300" StudentEnrolmentFieldType="StudentDetailUserDefined17" CustomFieldType="TickBox"></cc1:StudentEnrolmentField>
          </div>
      <div class="col-sm-6 columns form-group"> 
                     <cc1:StudentEnrolmentField id="StudentEnrolmentField5" runat="server" customcaption="Do you have Functional Skills vL2 in Maths?" isrequired="False" labelwidth="300" StudentEnrolmentFieldType="StudentDetailUserDefined18"  CustomFieldType="TickBox"></cc1:StudentEnrolmentField>
          </div>
